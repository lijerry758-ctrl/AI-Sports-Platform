...
## 十四、 未來展望
未來 CampusEye Lite 可進一步串接 YOLO、OpenCV、Jetson Orin Nano 與攝影機，讓系統從目前的前端人流紀錄與幾何分析平台，升級為即時智慧教室與姿態辨識系統。

未來也可以加入更多外部資料，例如課表、校園活動、天氣、考試週等因素，讓系統能更準確地分析與預測校園空間使用情況。
